...
#define USB30_PRIM_MOCK_UTMI_CLK_SRC_RCGR 0x1a034
...
// FIXME: this should not be needed, fix the impl in clock-qcom.c!
...
static int qcm2290_enable(struct clk *clk)
{
	...
	case GCC_USB30_PRIM_MASTER_CLK:
		...
		init_rcg2_clk(priv->base + USB30_PRIM_MOCK_UTMI_CLK_SRC_RCGR, 1);
		break;
	}
